...
def main():
    ...
    print(embedding_searcher.search(query="What are the tradeoffs and assumptions of intensity normalization using an internal standard reference of MALDI MSI datasets with multiple samples?"))
